...
public class LatLngRectTest extends TestCase {
  ...
  private static final LatLng C = new LatLng(ON, 0);
  ...
  private static final LatLng G = new LatLng(0, ON);
  ...
  private static final LatLng S = new LatLng(-OUT, 0);
  private static final LatLng SSW = new LatLng(-OUT, -IN); 
  private static final LatLng SW = new LatLng(-OUT, -OUT);
