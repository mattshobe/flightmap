...
public interface AviationDbAdapter extends DbAdapter {
	 ...
	 * 
	 * @param pattern
	 *            A SQL "LIKE" query pattern. A percent symbol ("%") matches any
	 *            sequence of zero or more characters, an underscore ("_")
	 *            matches any single character. Any other character matches
	 *            itself or its lower/upper case equivalent (i.e.
	 *            case-insensitive matching).
	 * 
	 * @see <a href="http://www.sqlite.org/lang_expr.html#like">The LIKE and
	 *      GLOB operators</a>
	 */
	...
	/**
	 * Returns a list of airports in the given cells with rank >=
	 * {@code minRank}.
	 */
	public Collection<Airport> getAirportsInCells(int startCell, int endCell,
			int minRank);
